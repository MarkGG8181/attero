...
@ModuleInfo(name = "SwingAnimations", description = "Modifies your swinging animations", category = ModuleCategory.RENDER)
public class SwingAnimationsModule extends AbstractModule {
    ...
    @Subscribe
    private void onHandSwing(HandSwingDurationEvent event) {
