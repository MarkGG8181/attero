...
public class AutoTotemModule extends AbstractModule {
    private final NumberSetting inventoryOpenDelay = new NumberSetting("Inventory Open Delay", 60, 0, 750);
    ...
    private void thing() {
        for (int i = 0; i < 36; i++) {
            ...
            if (item.getItem() == Items.TOTEM_OF_UNDYING) {
                ...
                if (!(mc.currentScreen instanceof InventoryScreen) && timer.hasElapsed(inventoryOpenDelay.toInt(), true)) {
